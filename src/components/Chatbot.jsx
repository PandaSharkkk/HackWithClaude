  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-blue-600 text-white p-4 border-b border-blue-700">
        ...
        <p className="text-sm text-blue-100 mt-1">Ask me about food, water, shelter, and more</p>
      </div>
      ...
      <div className="p-4 bg-white border-t border-gray-200">
        <div className="flex flex-col space-y-2">
          ...
          <button
            ...
            className="bg-blue-600 text-white rounded-lg px-4 py-3 hover:bg-blue-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed font-medium"
          >
